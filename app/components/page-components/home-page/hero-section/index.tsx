    ...
    <section className="body-font text-gray-600">
      <div className="mx-auto flex flex-col items-center py-24 md:flex-row md:px-5">
        <div className="mb-16 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:pr-16 md:text-left lg:flex-grow lg:pr-24">
          <h1 className="text-4xl font-extrabold text-[#252628] dark:text-white md:text-6xl">
            Build superior digital <span className="text-primaryDarkBlue">connections.</span>
          </h1>
