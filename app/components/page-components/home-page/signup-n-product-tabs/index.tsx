...
const HomeSignUpNProductTabsSection: FC = () => {
  return (
    <section className="box-border bg-[#f5f6f7] py-10 text-xl">
      <div>
        <div className="px-10 pb-3 pt-0">
          <h2 className="text-center text-xl font-extrabold text-blue-600">Curated connections start with just one click.</h2>
